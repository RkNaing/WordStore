...
class WordHolder private constructor(
    ...
    fun bindWord(wordWithCategory: WordWithCategory) {
        itemWordTvTitle.text = wordWithCategory.word.title
        itemWordTvDesc.text = wordWithCategory.word.description
        itemWordCategoryTitleTv.text = wordWithCategory.wordCategory.title
